(self["webpackChunkantd_react_template"] = self["webpackChunkantd_react_template"] || []).push([["mf-dep_vendors-node_modules_ahooks_es_index_js"],{
...
function createUseStorageState(getStorage) {
  function useStorageState(key, options) {
    ...
    var updateState = function updateState(value) {
      ...
      } else if ((0,_utils__WEBPACK_IMPORTED_MODULE_1__.isFunction)(value)) {
    ...
    return [state, (0,_useMemoizedFn__WEBPACK_IMPORTED_MODULE_3__.default)(updateState)];
  }
...
function useControllableValue(props, options) {
  ...
  return [stateRef.current, (0,_useMemoizedFn__WEBPACK_IMPORTED_MODULE_3__.default)(setState)];
}
