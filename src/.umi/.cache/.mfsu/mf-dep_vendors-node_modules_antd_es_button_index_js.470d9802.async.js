(self["webpackChunkantd_react_template"] = self["webpackChunkantd_react_template"] || []).push([["mf-dep_vendors-node_modules_antd_es_button_index_js"],{
...
var ButtonGroup = function ButtonGroup(props) {
  ...
  switch (size) {
    ...
    default:
      (0,_util_devWarning__WEBPACK_IMPORTED_MODULE_5__.default)(!size, 'Button.Group', 'Invalid prop `size`.');
  }
...
var InternalButton = function InternalButton(props, ref) {
  ...
  (0,_util_devWarning__WEBPACK_IMPORTED_MODULE_12__.default)(!(typeof icon === 'string' && icon.length > 2), 'Button', "`icon` is using ReactNode instead of string naming in v4. Please check `".concat(icon, "` at https://ant.design/components/icon"));
  (0,_util_devWarning__WEBPACK_IMPORTED_MODULE_12__.default)(!(ghost && isUnBorderedButtonType(type)), 'Button', "`link` or `text` button can't be a `ghost` button.");
